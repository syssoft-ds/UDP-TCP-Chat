...
public class TCP_Chat_Client {
        ...
        try (Socket socket = new Socket(serverIP, serverPort);
            ...
            while ((userInput = stdIn.readLine()) != null) {
                ...
                if (parts[0].equalsIgnoreCase("send") && parts.length == 3) {
                    ...
                    sendAllMessage(parts[1], out);
                    System.err.println("Message to all clients.");
                } else {
    ...
    private static void sendAllMessage(String message, PrintWriter out){
        out.println("sendAll" + message);
    }
}